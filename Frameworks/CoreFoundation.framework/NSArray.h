...
@interface NSArray : NSObject <CKRecordValue, CSCoderEncoder, INCacheableContainer, INIntentResolutionResultDataProviding, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding>
