...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWPortraitSceneMonitor, BWZoomCompletionDelegate> {
    ...
    bool  _portraitFilterRequiresBackgroundSeparationLikelihood;
    ...
    float  _sdofBackgroundSeparationLikelihood;
    float  _sdofBackgroundSeparationLikelihoodThreshold;
    bool  _sdofBackgroundSeparationMonitoringEnabled;
    ...
    bool  _sdofSceneDoesNotHaveEnoughBackgroundSeparation;
...
@property (nonatomic) bool portraitFilterRequiresBackgroundSeparationLikelihood;
...
- (bool)portraitFilterRequiresBackgroundSeparationLikelihood;
- (int)position;
...
- (int)resolveSDOFStatusWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 frameStatistics:(struct { double x1; float x2; float x3; double x4; float x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned char x10; unsigned char x11; unsigned int x12; int x13; int x14; unsigned int x15; float x16; unsigned char x17; double x18; int x19; int x20; int x21; float x22; float x23; int x24; int x25; int x26; float x27; float x28; int x29; int x30; int x31; int x32; long long x33; }*)arg2 flashModeForSceneMonitoring:(int)arg3 hdrModeForSceneMonitoring:(int)arg4 sisModeForSceneMonitoring:(int)arg5;
...
- (void)setPortraitFilterRequiresBackgroundSeparationLikelihood:(bool)arg1;
...
- (void)setSDOFBackgroundShiftSum:(float)arg1 invalidShiftRatio:(float)arg2 backgroundSeparationLikelihood:(float)arg3 closeCanonicalDisparityAverage:(float)arg4 erodedForegroundRatio:(float)arg5 foregroundRatio:(float)arg6;
...
- (void)updatePortraitFilterRequiresBackgroundSeparationLikelihood:(bool)arg1;
- (void)updateSDOFBackgroundShiftSum:(float)arg1 invalidShiftRatio:(float)arg2 backgroundSeparationLikelihood:(float)arg3 closeCanonicalDisparityAverage:(float)arg4 erodedForegroundRatio:(float)arg5 foregroundRatio:(float)arg6;
